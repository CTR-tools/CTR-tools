...
how to use:
- put lev files in "levels" folder
- launch viewer
...
how to use texture replacement:
- load level
...
xinput gamepad is strongly recommended, but mouse+keyboards is supported too

move: left stick/wasd
roatet: right stick/arrow keys/hold right mouse click and move mouse
